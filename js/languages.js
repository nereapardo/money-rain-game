const gameInstructions = {
  description: {
    es: `¿Quien dijo que el dinero no cae del cielo? En este juego la lluvia cae en forma de billetes de 100€, 200€ y 500€. Haz click en los billetes para recoger tantos como puedas.Tu misión es pasar los 3 niveles y hacerte rico. Por cada nivel aumentará la cantidad mínima de dinero a conseguir y la velocidad. Intenta llenar tu cartera al máximo, pero ten cuidado, porque la avaricia rompe el saco.`,
